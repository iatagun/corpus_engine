...
const utils_1 = require("@corpus/utils");
...
async function main() {
    ...
    const parser = new utils_1.ConlluStreamParser(path_1.default.join(process.cwd(), 'apps/indexer/synthetic_100k.conllu'), 'dry_run_corpus', 'doc_1');
    ...
    const qb = new query_builder_js_1.QueryBuilder();
    const sampleQuery = {
